const words = ["kuliahnya lancar", "tambah dewasa", "tambah keren", "panjang umur", "sukses selalu", "sehat selalu"];
let cursor = gsap.to(".cursor", { opacity: 0, ease: "power2.inOut", repeat: -1 });
let boxTl = gsap.timeline();
boxTl
  .to(".box", { duration: 1, width: "65vw", delay: 0.5, ease: "power4.inOut" })
